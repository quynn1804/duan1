    ...
    <section class="featured spad">
        <div class="container">
            ...
            <?php
                            ...
                            foreach($query as $value){
                                ?>
                            <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat <?php echo $value['type_id'] ?>">
                    <div class="featured__item">
                    <?php
                            $sql = "SELECT * FROM `product` WHERE `type_id` = ".$value['type_id'];
                            $query = getAll($sql);
                        ...
                        <div class="featured__item__text">
                            <h6><a href="#"><?= $key['product_avatar'] ?></a></h6>
                            <h5>$30.00</h5>
                        </div>
                                <?php
                            }
