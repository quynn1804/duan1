    ...
    <table class="table">
        ...
        foreach($cates as $cate ): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?act=sua_type&id=<?=$cate['id']?> " class="btn-sua" >Sửa</a>
                    <a href="index.php?act=xoa_type&id=<?=$cate['id']?> " class="btn-xoa"   onclick="return confirm('Bạn có chắc xóa không?')">Xóa</a>
                </td>
