<?php
    ...
    $query = connect($sql) -> fetchAll();
    if($query['product_view'] === 0){
        if(!isset($_SESSION['view'][$id])){
            $view = $_SESSION['haha'][$id] = 1;
        }
        else{
        ...
        if(!isset($_SESSION['view'][$id])){
            ...
            $view = $_SESSION['view'][$id] += 1;
            $views = $query['product_view'];
            $sql2 = "UPDATE `product` SET `product_view` = $views WHERE `product_id` = $id";
            connect($sql2);
        }
}
?>
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="./src/imgs/img_product/<?= $item['product_avatar'] ?>" alt="">
                        </div>
