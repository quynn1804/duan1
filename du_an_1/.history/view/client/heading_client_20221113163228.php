    ...
    <div class="humberger__menu__wrapper">
        ...
        <!-- <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li>
                    <a href="index.php?act=page">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="index.php?act=page">Shop Details</a></li>
                        <li><a href="index.php?act=page">Shoping Cart</a></li>
                        <li><a href="index.php?act=page">Check Out</a></li>
                        <li><a href="index.php?act=page">Blog Details</a>
                    </li>
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="index.php?act=cart"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>$150.00</span></div>
                    </div>
                </div>
