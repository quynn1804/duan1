                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            <p style="color:red"><?php echo $noti ?></p>
                            ...
                            <form method="post" action="">
                                ...
                                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="index.php?act=login" class="fw-bold text-body"><u>Login here</u></a></p>
                                <?php
            if(!empty($err)){
