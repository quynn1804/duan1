...
<body>
    ...
    <section class="max-w-6xl mx-auto mb-[40px] mt-4">
        ...
        <form action="" method="post" class="mt-4">
            ...
            <input type="text" name="" class="border-2 w-full h-[32px] mt-2">
            <p class="font-bold text-[18px] mt-5">tên tài khoản</p>
            <input type="text" name="" class="border-2 w-full h-[32px] mt-2"><br />
            ...
            <button class="text-white bg-orange-600 text-[20px] border-2 mt-4">Đăng ký</button>
