...
<header class="bg-gray-100 pb-4">
    <section class="bg-red-500 flex mb-4">
        <div class="w-[555px]">
            <p class="text-white ml-4">Chào mừng bạn đến với mẫu website bán hàng của DKQT</p>

        </div>
        <div class="ml-[300px]">
            <ul class="flex pr-auto gap-8">
                <li><a class="text-white" href="">tài khoản</a></li>
                <li><a class="text-white" href="">sản phẩm</a></li>
                <li><a class="text-white" href="">hệ thông cửa hàng</a></li>
            </ul>
        </div>
    </section>
    <section class="max-w-6xl mx-auto mb-[40px]">
        ...
        <div class="flex justify-between mb-5">
            ...
            <div class="menu">
                <ul class="flex space-x-8 bg-white">
                    <li class="hover:bg-red-500"><a href="./home_user.php">trang chủ</a></li>
                    <li class="hover:bg-red-500"><a href="./view/product.php">sản phẩm</a></li>
                    <li class="hover:bg-red-500"><a href="./view/news.php">tin tức</a></li>
                    <li class="hover:bg-red-500"><a href="./view//login.php">Đăng nhập</a></li>
                    <li class="hover:bg-red-500"><a href="./view/signin.php">Đăng ký</a></li>
                    <li class="hover:bg-red-500"><a href="./view/forgot_pass.php">Quyên mật khẩu</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="flex basis-[30%]     ">
            <ul class="space-y-4 w-[195px] bg-white  mr-8 ">
                <li class="hover:bg-orange-500"><a href=""><i class="fa-solid fa-star"></i> Đức nè mọi người</a></li>
                <li class="hover:bg-orange-500"><a href=""><i class="fa-solid fa-star"></i> Đức nè mọi người</a></li>
                <li class="hover:bg-orange-500"><a href=""><i class="fa-solid fa-star"></i> Đức nè mọi người</a></li>
                <li class="hover:bg-orange-500"><a href=""><i class="fa-solid fa-star"></i> Đức nè mọi người</a></li>
                <li class="hover:bg-orange-500"><a href=""><i class="fa-solid fa-star"></i> Đức nè mọi người</a></li>
