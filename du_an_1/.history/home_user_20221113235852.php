                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="index.php?act=home_user">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="index.php?act=home_user">Shop Details</a></li>
                                    <li><a href="index.php?act=home_user">Shoping Cart</a></li>
                                    <li><a href="index.php?act=home_user">Check Out</a></li>
                                    <li><a href="index.php?act=home_user">Blog Details</a></li>
                                </ul>
                            </li>
                            <li><a href="index.php?act=home_user">Blog</a></li>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="./src/img/banner.jpg">
                        <div class="hero__text">
                            <span>Đức Luxyry</span>
                            <h2>Fashion<br />100% Quanlity</h2>
                            <p>Nhận và giao hàng miễn phí có sẵn</p>
                            <a href="index.php?act=san_pham" class="primary-btn">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="featured spad">
        <div class="container">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            ?>
                                ...
                                <li data-filter=".<?php echo $value['type_id'] ?>"><?php echo $value['type_name'] ?></li>
                                <!-- <li data-filter=".quanau">Quần âu</li>
                            <li data-filter=".giaytay">Giày tây</li>
                            <li data-filter=".vest">Vest</li>
                            <li data-filter=".vest">Phụ kiện</li> -->
                            <?php
                            }
                            ?>
                        </ul>
            ...
            <div class="row featured__filter">
                ...
                foreach ($query as $value):
                ?>
                    <div class="col-3 mix <?php echo $value['type_id'] ?>">
                        <div class="featured__item">
                            <?php
                            $sql = "SELECT * FROM product WHERE type_id = 35 LIMIT 4"; ;
                            $query = getAll($sql);
                            foreach ($query as $key):
                            ?>
                                <div class="featured__item__pic">
                                    <img src="./src/imgs/img_product/<?= $key['product_avatar'] ?>" alt="">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="index.php?act=detail_product"><i class="fa-solid fa-circle-info"></i></a></li>
                ...
                <?php endforeach
                ?>
                <!-- <div class="col-lg-3 col-md-4 col-sm-6 mix 1 fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg">
                            <img src="" alt="">
                            <ul class="featured__item__pic__hover">
