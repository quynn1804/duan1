        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fnoithatxinh.net.vn%2Fthiet-ke-shop-quan-ao-nam-don-gian%2F&psig=AOvVaw2LXlpKMm0p8iZFXNrHpRzN&ust=1668416439775000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCLiO8dvlqvsCFQAAAAAdAAAAABAE')">
            ...
            <div class="row">
                ...
                <?php
                            ...
                            foreach($query as $item){
                                ?>
                                <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="./src/imgs/img_type/<?= $item['type_avatar'] ?>">
                            <h5><a href="#"><?= $item['type_name']?></a></h5>
                        </div>
                    </div>
                                <?php
                            }
